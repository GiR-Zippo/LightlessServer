...
using LightlessSync.API.Dto.Account;
using Microsoft.EntityFrameworkCore;
using System.Collections.Concurrent;
using System.Text.RegularExpressions;

namespace LightlessAuthService.Services;
...
public class AccountRegistrationService
{
    ...
    private readonly LightlessDbContext _mareDbContext;
    ...
    private Regex _registrationUserAgentRegex = new Regex(@"^LightlessSync", RegexOptions.Compiled);

    public AccountRegistrationService(LightlessMetrics metrics, IDbContextFactory<LightlessDbContext> mareDbContextFactory,
